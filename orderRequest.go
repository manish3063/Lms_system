...
func createOrderRequest(reqbody Order) (bool, string) {
	...
	sqlStatement := `INSERT INTO order_request(book_id, student_id,issue_date, return_date, actual_return_date, approved)
VALUES ($1, $2, $3, $4, $5, $6)`
